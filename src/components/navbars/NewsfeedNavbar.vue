<template>
  <body class="bg-blue-500">
    ...
    >
      ...
      >
        <LanguageDropdown />
        <SearchDropdown @click="showSearch" class="mr-5 block md:hidden" />
      ...
      >
        <BackArrowIcon @click="showSearch" class="mr-3" />
...
import LanguageDropdown from "@/components/ui/dropdowns/LanguageDropdown.vue";
import NotificationsDropdown from "@/components/ui/dropdowns/NotificationsDropdown.vue";
import SearchDropdown from "@/components/ui/dropdowns/SearchDropdown.vue";
import BackArrowIcon from "@/components/ui/icons/BackArrowIcon.vue";
import NewsfeedSidebar from "@/components/pages/user/newsfeed/NewsfeedSidebar.vue";
